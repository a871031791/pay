...
public class PropertiesUtils {
	...
	public static String getUserDirProperty(String key, String filename) {
		String absolutePath = System.getProperty("user.home") + File.separator + "props" + File.separator + filename;
	 ...
	 * @return 值
	 */
	public static Properties loadClassPathProperty(String fileName) {
