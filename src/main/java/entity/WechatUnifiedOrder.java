...
public class WechatUnifiedOrder {
	...
	private String sign_type;// 签名类型 sign_type 否 String(32) HMAC-SHA256
	...
	public static class Response {
		...
		private String sub_appid; // 子商户公众账号ID sub_appid 否 String(32)
									// wx8888888888888887 微信分配的子商户公众账号ID
		...
		private String trade_type;// 交易类型 trade_type 是 APP JSAPI MWEB
